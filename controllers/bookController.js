...
exports.index = function (req, res) {
    ...
    async.parallel({
        ...
        book_instance_Disponible_count: function (callback) {
            BookInstance.countDocuments({ status: 'Disponible' }, callback);
        },
...
exports.book_delete_post = function (req, res, next) {
    ...
    async.parallel({
        ...
        if (results.book_instance.length > 0) {
            ...
            // Book has no bookinstances. Delete object and redirect to the list of bookinstace.
